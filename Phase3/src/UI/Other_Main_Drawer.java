...
//    private static final double SCENE_SIZE = 700;
    ...
    public void start(Stage stage) throws Exception {
        ...
        RadioButton GreedyButton = new RadioButton("Bruteforce.Greedy Algorithm");
        GreedyButton.setToggleGroup(group);
        GreedyButton.setSelected(true);
        RadioButton rb2 = new RadioButton("Bruteforce.BruteGreedy");
        rb2.setToggleGroup(group);
        RadioButton ga = new RadioButton("Genetic Algorithm");
        ga.setToggleGroup(group);
...
//        Button clearbuttonga = new Button("CLEAR FOR G.A.");
//        clearbuttonga.setPrefWidth(TOOLBAR_WIDTH);
//        clearbuttonga.setOnAction(new EventHandler<ActionEvent>() {
//            @Override
//            public void handle(ActionEvent event) {
//                System.out.println("CLEAR PRESSED");
//                clearSceneForGA();
...
//        Pentomino penp = new PentominoP(0,0,3,SIZE_TRANSFORMATION);
    ...
    public static void addBox(double w, double h, double d, double x, double y, double z,Color boxc, boolean flag) {
        ...
        double multiplier;
        if (flag) {
            multiplier = SIZE_TRANSFORMATION;
        } else {
            multiplier = 5;
        }
        createLines(w, h, d, x, y, z, multiplier);
...
//        z *= SIZE_TRANSFORMATION;
     ...
     * @param z z-location
     */
    public static void createLines(double contW, double contH, double contD, double x, double y, double z, double multiplier) {
//        x *= SIZE_TRANSFORMATION;
//        y *= SIZE_TRANSFORMATION;
//        z *= SIZE_TRANSFORMATION;
